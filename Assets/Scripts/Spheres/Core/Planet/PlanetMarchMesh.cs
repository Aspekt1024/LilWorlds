...
namespace Aspekt.Spheres
{
    public class PlanetMarchMesh
    {
        ...
        public PlanetMarchMesh(Transform parent)
        {
            this.parent = parent;
        }

        public void Generate(SphereDensitySettings densitySettings, TerrainMarchShapeSettings shapeSettings, TerrainMarchShadingSettings shadingSettings)
        {
            // DENSITY
            ...
            GenerateMesh(terrainTf, tris, shadingSettings.material, shapeSettings.floorLevel);
        }
        ...
        private void GenerateMesh(Transform terrainTf, Triangle[] triangles, Material material, float floorLevel)
        {
            ...
            material.SetFloat("_FloorLevel", floorLevel);
        ...
        {
            maxHeight = Mathf.Max(maxHeight, vert.pos.magnitude); // TODO relative to centre of planet
            minHeight = Mathf.Min(minHeight, vert.pos.magnitude); // TODO relative to centre of planet
